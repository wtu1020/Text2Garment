...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        anc_feature = hidden_states.reshape(batch, height, width, inner_dim) # # b, c, h, w
        ...
        if not return_dict:
            return (output, anc_feature)

        return Transformer2DModelOutput(sample=output, anc_feature=anc_feature)
